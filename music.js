(() => {
  ...
  theme.textContent = `
    ...
    *,button,a,input,textarea,select{font-family:'Italianno','Brush Script MT',cursive!important}
    ...
    .masthead-date,.text-button,.personal-note,.cover-copy,.duration,.button,.surname,.birthday-note,.date-side,.address,.finale-name,.final-details p,.final-details span,.whatsapp-note,.player-bottom>span{font-family:'Italianno','Brush Script MT',cursive!important;letter-spacing:.025em!important}
    .masthead-date{font-size:18px!important}
    .text-button{font-size:18px!important}
    .personal-note{font-size:20px!important}
    .cover-copy{font-size:20px!important}
    .button{font-size:20px!important}
    .duration{font-size:16px!important}
    .surname{font-size:31px!important}
    .birthday-note,.date-scene .scene-content>p:last-child,.dress-scene p:last-child{font-size:19px!important}
    .address{font-size:23px!important}.address span{font-size:19px!important}
    .finale-name{font-size:19px!important}.final-details p{font-size:18px!important}.final-details span{font-size:16px!important}
    .whatsapp-note,.player-bottom>span{font-size:16px!important}
  `;
